...
public final class cadastroUsuario_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\r\n");
      out.write("    <head>\r\n");
      out.write("        <title>Marvel Shopp - Cadastro</title>\r\n");
      ...
      out.write("                <form method=\"post\" id=\"cadUsu\" action=\"\" oninput=\"calc_total();\"> <!--tag para criação de formularios-->\r\n");
      out.write("                    <fieldset id=\"usuario\"> <!--cria um conjunto de campos-->\r\n");
      out.write("                        <legend>Cadastre-se</legend><!--cria o titulo do conjunto de campos-->\r\n");
      out.write("                        <h3>Preencha o formulário abaixo</h3>\r\n");
      ...
      out.write("                        <p><label for=\"cSenha\">Senha: <input type=\"password\" name=\"tSenha\" id=\"cSenha\" size=\"8\" maxlength=\"8\" placeholder=\"Mínimo de 8 dígitos\"/></label></p>\r\n");
      out.write("                        <p><label for=\"cSenha2\">Confirme sua Senha: <input type=\"password\" name=\"tSenha2\" id=\"cSenha2\" size=\"8\" maxlength=\"8\" placeholder=\"Mínimo de 8 dígitos\"/></label></p>\r\n");
      out.write("                        <p><label for=\"cSenha\">CPF: <input type=\"number\" name=\"tSenha\" id=\"cSenha\" size=\"8\" maxlength=\"8\" placeholder=\"Somente números\"/></label></p>\r\n");
      ...
      out.write("                        <fieldset id=\"sexo\"><!--cria um conjunto de campos-->\r\n");
      out.write("                            <p>Sexo</p><!--cria o titulo do conjunto de campos-->\r\n");
      out.write("                            <input type=\"radio\" name=\"tSexo\" id=\"cMasc\" checked/><label for=\"cMasc\">Masculino</label><!--lembrar que o name tem que ser igual neste caso. o label for serve para tornar o nome clicavel. checked: deixa o item ja marcado-->\r\n");
      out.write("                            <input type=\"radio\" name=\"tSexo\" id=\"cFem\"/><label for=\"cFem\">Feminino</label>\r\n");
      out.write("                        </fieldset>\r\n");
      ...
      out.write("                        <input type=\"checkbox\" name=\"tOferta\" id=\"cOferta\"/><label for=\"cFem\">Desejo receber ofertas por e-mail</label>\r\n");
      out.write("                    </fieldset> \r\n");
      out.write("                    </br>\r\n");
      out.write("                    <input type=\"submit\" value=\"criar seu cadastro\" id=\"bCad\"/><!--cria um botao enviar a partir de uma imagem. Outra opção: <input type=\"submit\" value=\"enviar\"/>-->\r\n");
      out.write("                </form>\t                      \r\n");
      out.write("            </section>\r\n");
      out.write("            \r\n");
      out.write("            ");
