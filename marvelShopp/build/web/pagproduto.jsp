...
<html>
    ...
    <div class ="grid-item ficha">
        <p>Nome real: mãe do shinji</p>
         ...
         <textarea  placeholder="digite um comentario" rows="10" cols="50"></textarea>
         ...
         <div class="radio">
                    ...
                    <label class="labels" for="star-5">5</label>
                     ...
                     <input type="radio"  id="star-4" name="star"value="5">
                      <label  class="labels" for="star-4">4</label>
                    
                    
                     <input type="radio"  id="star-3" name="star"value="5">
                     <label  class="labels" ></label>
                     
                     
                     <input type="radio" class="star star-2" id="star-2" name="star"value="5">
                     
                      <label  class="labels" >2</label>
                    
                     <input type="radio" class="star star-1" id="star-1" name="star"value="5">
