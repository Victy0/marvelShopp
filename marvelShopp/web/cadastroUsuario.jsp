            ...
            <section id="corpo"> <!--divisão da pagina. Aqui se inicia o corpo da pagina (seção do meio)-->
                <form method="post" id="cadUsu" action="UsuarioController" oninput="calc_total();"> <!--tag para criação de formularios-->
                    <fieldset id="usuario"> <!--cria um conjunto de campos-->
                        ...
                        <p><label for="cSenha">CPF: <input type="number" name="tCpf" id="cSenha" size="8" maxlength="8" placeholder="Somente números"/></label></p>
                        ...
                        <fieldset id="sexo"><!--cria um conjunto de campos-->
                            ...
                            <input type="radio" name="tSexo" id="cMasc" value="Masculino" checked/><label for="cMasc">Masculino</label><!--lembrar que o name tem que ser igual neste caso. o label for serve para tornar o nome clicavel. checked: deixa o item ja marcado-->
